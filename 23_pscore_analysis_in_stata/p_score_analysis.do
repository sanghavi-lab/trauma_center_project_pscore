        ...
        * Create splines for niss and riss to allow for flexibility based on bands from past literature
        ...
        if inlist("`a'","amb","ipA", "opA"){ /* If subgroup is ambulance rides, then I need to specify a slightly different model with ambulance-specific covariates: amb type, miles, and modifiers */
            ...
            * Step 1 logit (since this is for those who took an ambulance, I controlled for ib1.amb_type c.MILES SH_ind EH_ind NH_ind RH_ind)
            ...
            ib0.metro_micro_cnty cllge gen_md med_cty full_dual_ind ib1.amb_type c.MILES SH_ind EH_ind NH_ind RH_ind, save(appendix_logit_table_`a'_`t') replace
        }
            ...
            * Step 1 logit
            ...
            CANCER_ENDOMETRIAL_EVER_ind ANEMIA_EVER_ind ASTHMA_EVER_ind HYPERL_EVER_ind HYPERP_EVER_ind HYPERT_EVER_ind HYPOTH_EVER_ind ///
            MULSCL_MEDICARE_EVER_ind OBESITY_MEDICARE_EVER_ind EPILEP_MEDICARE_EVER_ind median_hh_inc_ln pvrty fem_cty eld_cty ///
            ib0.metro_micro_cnty cllge gen_md med_cty full_dual_ind, save(appendix_logit_table_`a'_`t') replace
        }
    ...
    * Create list to loop
    ...
    foreach x of local treatment_list{
        ...
        * Set file name for excel sheet with modify option to create new table to store the balance tables
        ...
        putexcel A10 = "``z'`x'comorbidtn'"
        putexcel B10 = "``z'`x'comorbidcn'"
        putexcel C10 = "``z'`x'comorbid_p'"
        putexcel G10 = "``z'`x'comorbidtp'"
        putexcel H10 = "``z'`x'comorbidcp'"

        putexcel A11 = "``z'`x'nisstn'"
        putexcel B11 = "``z'`x'nisscn'"
        putexcel C11 = "``z'`x'niss_p'"
        putexcel G11 = "``z'`x'nisstp'"
        putexcel H11 = "``z'`x'nisscp'"

        putexcel A12 = "``z'`x'risstn'"
        putexcel B12 = "``z'`x'risscn'"
        putexcel C12 = "``z'`x'riss_p'"
        putexcel G12 = "``z'`x'risstp'"
        putexcel H12 = "``z'`x'risscp'"

        putexcel A13 = "``z'`x'BLOODPTtn'"
        putexcel B13 = "``z'`x'BLOODPTcn'"
        putexcel C13 = "``z'`x'BLOODPT_p'"
        putexcel G13 = "``z'`x'BLOODPTtp'"
        putexcel H13 = "``z'`x'BLOODPTcp'"

        putexcel A14 = "``z'`x'm_hh_inctn'"
        putexcel B14 = "``z'`x'm_hh_inccn'"
        putexcel C14 = "``z'`x'm_hh_inc_p'"
        putexcel G14 = "``z'`x'm_hh_inctp'"
        putexcel H14 = "``z'`x'm_hh_inccp'"

        putexcel A16 = "``z'`x'pvrtytn'"
        putexcel B16 = "``z'`x'pvrtycn'"
        putexcel C16 = "``z'`x'pvrty_p'"
        putexcel G16 = "``z'`x'pvrtytp'"
        putexcel H16 = "``z'`x'pvrtycp'"

        putexcel A17 = "``z'`x'fem_ctytn'"
        putexcel B17 = "``z'`x'fem_ctycn'"
        putexcel C17 = "``z'`x'fem_cty_p'"
        putexcel G17 = "``z'`x'fem_ctytp'"
        putexcel H17 = "``z'`x'fem_ctycp'"

        putexcel A18 = "``z'`x'eld_ctytn'"
        putexcel B18 = "``z'`x'eld_ctycn'"
        putexcel C18 = "``z'`x'eld_cty_p'"
        putexcel G18 = "``z'`x'eld_ctytp'"
        putexcel H18 = "``z'`x'eld_ctycp'"

        putexcel A19 = "``z'`x'metrotn'"
        putexcel B19 = "``z'`x'metrocn'"
        putexcel C19 = "``z'`x'metro_p'"
        putexcel G19 = "``z'`x'metrotp'"
        putexcel H19 = "``z'`x'metrocp'"

        putexcel A20 = "``z'`x'cllgetn'"
        putexcel B20 = "``z'`x'cllgecn'"
        putexcel C20 = "``z'`x'cllge_p'"
        putexcel G20 = "``z'`x'cllgetp'"
        putexcel H20 = "``z'`x'cllgecp'"

        putexcel A21 = "``z'`x'gen_mdtn'"
        putexcel B21 = "``z'`x'gen_mdcn'"
        putexcel C21 = "``z'`x'gen_md_p'"
        putexcel G21 = "``z'`x'gen_mdtp'"
        putexcel H21 = "``z'`x'gen_mdcp'"

        putexcel A22 = "``z'`x'med_ctytn'"
        putexcel B22 = "``z'`x'med_ctycn'"
        putexcel C22 = "``z'`x'med_cty_p'"
        putexcel G22 = "``z'`x'med_ctytp'"
        putexcel H22 = "``z'`x'med_ctycp'"
