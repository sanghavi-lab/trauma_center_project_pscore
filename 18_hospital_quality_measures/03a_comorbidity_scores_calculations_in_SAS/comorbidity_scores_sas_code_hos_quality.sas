...
/* Running the following script in terminal to run in phs (for final code): "/usr/local/SASHome/SASFoundation/9.4/sas" -SYSIN /mnt/labshares/sanghavi-lab/Jessy/hpc_utils/codes/python/trauma_center_project/final_codes_python_sas_R_stata/18_hospital_quality_measures/03a_comorbidity_scores_calculations_in_SAS/comorbidity_scores_sas_code_hos_quality.sas -LOG /mnt/labshares/sanghavi-lab/Jessy/hpc_utils/codes/sas/trauma_center_project/log/job1.log */
...
guessingrows=4000000; /* This will "guess" the column type through examining the N rows. Need this to force DX column as character. */
delimiter=',';
datarow=2;
getnames=YES;
run;
